...
public class EnvioCorreoSmptGmail implements IEnvioCorreo {
    private ILoggerService loggerService;
    private String host;
    private String password;
    private int port;
    private final static String MESSAGE = "Envio de correo haciendo uso del servicio smtp de gmail";

    public EnvioCorreoSmptGmail(){}

    public EnvioCorreoSmptGmail(ILoggerService loggerService) {
        this.loggerService = loggerService;
    }

    public EnvioCorreoSmptGmail(ILoggerService loggerService, String host, String password, int port) {
        this.loggerService = loggerService;
        this.host = host;
    ...
    public EnvioCorreoSmptGmail(String host, String password, int port) {
        this.host = host;
        this.password = password;
        this.port = port;
    }
